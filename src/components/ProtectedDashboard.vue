      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-slate-100">
        ...
        <div class="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            <span>Re-consultar /api/users/me</span>
          </button>
          <button
            id="btn-goto-mongo"
            @click="$emit('view-mongo')"
            class="px-3.5 py-2 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-800 font-bold text-xs transition-colors flex items-center gap-2 border border-emerald-200"
          >
            <Database class="w-3.5 h-3.5 text-emerald-600" />
            <span>Verificar en MongoDB</span>
          </button>
        </div>
      </div>
